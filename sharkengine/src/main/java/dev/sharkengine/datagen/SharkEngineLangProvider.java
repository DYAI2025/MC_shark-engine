...
final class SharkEngineLangProvider {
    ...
    static final class English extends FabricLanguageProvider {
        ...
        public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder b) {
            ...
            b.add("message.sharkengine.assembly_fail_invalid_target", "Assembly request rejected: use the nearby steering wheel again.");
            b.add("message.sharkengine.assembly_fail_world_changed", "Assembly cancelled because the structure changed. Reopen the builder.");
            b.add("message.sharkengine.assembly_fail_spawn", "Assembly failed safely. The original blocks were restored.");
            ...
            b.add("message.sharkengine.disassembly_blocked", "Cannot disassemble: target blocked at %s, %s, %s.");
            b.add("message.sharkengine.disassembly_overlap", "Cannot disassemble: rotated blueprint contains overlapping targets.");
            b.add("message.sharkengine.disassembly_failed", "Disassembly failed safely; placed blocks were rolled back.");
            ...
            b.add("screen.sharkengine.tutorial.flight_tips.body", "WASD to steer, Space to rise, Left Alt to descend. Monitor fuel and weight warnings.");
            ...
            b.add("hud.sharkengine.onboarding.vertical", "Vertical: Space rises, Left Alt descends. Heavy ships climb slower.");
    ...
    static final class German extends FabricLanguageProvider {
        ...
        public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder b) {
            ...
            b.add("message.sharkengine.assembly_fail_invalid_target", "Montageanfrage abgelehnt: Nutze das nahe Steuerrad erneut.");
            b.add("message.sharkengine.assembly_fail_world_changed", "Montage abgebrochen, weil sich die Struktur geändert hat. Öffne den Baumeister erneut.");
            b.add("message.sharkengine.assembly_fail_spawn", "Montage sicher fehlgeschlagen. Die ursprünglichen Blöcke wurden wiederhergestellt.");
            ...
            b.add("message.sharkengine.disassembly_blocked", "Zerlegen nicht möglich: Ziel bei %s, %s, %s ist blockiert.");
            b.add("message.sharkengine.disassembly_overlap", "Zerlegen nicht möglich: Der gedrehte Bauplan enthält überlappende Ziele.");
            b.add("message.sharkengine.disassembly_failed", "Zerlegen ist sicher fehlgeschlagen; platzierte Blöcke wurden zurückgesetzt.");
            ...
            b.add("screen.sharkengine.tutorial.flight_tips.body", "WASD zum Lenken, Leertaste zum Steigen, linke Alt-Taste zum Sinken. Achte auf Treibstoff- und Gewichtswarnungen.");
            ...
            b.add("hud.sharkengine.onboarding.vertical", "Vertikal: Leertaste steigt, linke Alt-Taste sinkt. Schwere Schiffe steigen langsamer.");
