...
- Max speed is weight-category dependent (aggregated part mass).
- High altitude applies a speed penalty.
- Vertical movement is supported (`Space` / rebindable `Left Alt`).
...
- Fuel refill works by right-clicking as pilot with logs or planks; UX feedback and balancing still need playtesting.
